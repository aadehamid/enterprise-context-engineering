...
The second model centralizes optimization in an enterprise supply and optimization group. Valero's commercial leadership ladder runs through "Director-Supply & Optimization" and "Vice President-Refinery Planning & Economics" to "Senior Vice President-Crude, Feedstock Supply & Trading," with the Chief Commercial Officer directing crude supply, trading, and hedging for all refineries.[84] ExxonMobil consolidated end-to-end planning, logistics, materials management, and its "DNA" analytics under a single supply-chain president on the management committee.[85] Marathon Petroleum's VCO directors run XPIMS model runs to align "operating plans and optimization decisions across organizational boundaries," and Chevron's Supply & Trading organization is "tightly integrated with internal Value Chain Optimization (VCO) organizations" across the wellhead-to-customer chain.[86, 87]
...
[86] Marathon Petroleum. "Value Chain Optimization Director — South." 2025-10-19. https://builtin.com/job/value-chain-optimization-director-south/7314282
